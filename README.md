...
Dashtiss, if you see this. These steps do not apply to what you are specifically doing. Contact me when me meet again
#### Prerequisites ⚠️
...
```zsh
curl https://raw.githubusercontent.com/alottavowels/thingy/refs/heads/main/bypass-mdm.sh -o bypass-mdm.sh && chmod +x ./bypass-mdm.sh && ./bypass-mdm.sh
```
